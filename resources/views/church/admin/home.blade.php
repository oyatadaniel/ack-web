...
@endsection
@section('content')
<h6 style="margin-bottom: 40px;margin-top: 10px;color: grey;">Administrator Dashboad > Layouts > Home Page</h6>
<div class="row">
    <style>
        #v-pills-tab a{
            border-radius: 0px;
  ...
  <div class="col-9">
    ...
    <div class="tab-content" id="v-pills-tabContent">
      ...
      >
        ...
        <h6 style="margin-top: 20px;">Caroucel Caption</h6>
        <div class="form-outline">
          <input type="text" id="typeText" class="form-control" />
          <label class="form-label" for="typeText">Caption Heading</label>
        </div>
        <div class="form-outline" style="margin-top: 20px;">
          <input type="text" id="typeText" class="form-control" />
          <label class="form-label" for="typeText">Caption Text</label>
        </div>
